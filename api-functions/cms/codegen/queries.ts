...
export type GraphQLContentfulOfferingExampleViolation = GraphQLContentfulEntry & {
  ...
  sys: GraphQLContentfulSys;
  contentfulMetadata: GraphQLContentfulContentfulMetadata;
  linkedFrom?: Maybe<GraphQLContentfulOfferingExampleViolationLinkingCollections>;
  title?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
...
export type GraphQLContentfulQuery = {
  ...
  resourcesAndContactsCollection?: Maybe<GraphQLContentfulResourcesAndContactsCollection>;
  offeringExampleViolation?: Maybe<GraphQLContentfulOfferingExampleViolation>;
  offeringExampleViolationCollection?: Maybe<GraphQLContentfulOfferingExampleViolationCollection>;
  ...
  landingExplanationCollection?: Maybe<GraphQLContentfulLandingExplanationCollection>;
  entryCollection?: Maybe<GraphQLContentfulEntryCollection>;
};
...
export type GraphQLContentfulAllBlogPostsQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GraphQLContentfulAllBlogPostsQuery = (
  ...
  & { blogPostCollection?: Maybe<(
    ...
    & { items: Array<Maybe<(
      { __typename: 'BlogPost' }
      & Pick<GraphQLContentfulBlogPost, 'path'>
    )>> }
  )> }
);

export type GraphQLContentfulBlogPostPageQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GraphQLContentfulBlogPostPageQuery = (
  ...
  & { pinnedPosts?: Maybe<(
    ...
    & { items: Array<Maybe<(
      { __typename?: 'BlogPost' }
      & Pick<GraphQLContentfulBlogPost, 'title' | 'path' | 'author' | 'tags' | 'externalUrl' | 'seoDescription'>
      & { image?: Maybe<(
        { __typename?: 'Asset' }
        & Pick<GraphQLContentfulAsset, 'url'>
      )>, richDescription?: Maybe<(
        { __typename?: 'BlogPostDescription' }
        & Pick<GraphQLContentfulBlogPostDescription, 'json'>
      )>, sys: (
        { __typename?: 'Sys' }
        & Pick<GraphQLContentfulSys, 'firstPublishedAt'>
      ) }
    )>> }
  )>, recentPosts?: Maybe<(
    { __typename?: 'BlogPostCollection' }
...
export type GraphQLContentfulLandingPageContentQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GraphQLContentfulLandingPageContentQuery = (
  ...
  & { entryCollection?: Maybe<(
    { __typename?: 'EntryCollection' }
    & { items: Array<Maybe<{ __typename: 'BlogPost' } | (
      { __typename: 'DidYouKnow' }
      & Pick<GraphQLContentfulDidYouKnow, 'title' | 'description' | 'sourceName' | 'sourceUrl' | 'order'>
    ) | (
      { __typename: 'LandingExplanation' }
      & Pick<GraphQLContentfulLandingExplanation, 'icon' | 'order'>
      & { richDescription?: Maybe<(
        { __typename?: 'LandingExplanationDescription' }
        & Pick<GraphQLContentfulLandingExplanationDescription, 'json'>
      )> }
    ) | (
      { __typename: 'LandingFact' }
      & Pick<GraphQLContentfulLandingFact, 'title' | 'description' | 'order' | 'lightTextColor'>
      ...
      { __typename: 'LandingMetadata' }
      & Pick<GraphQLContentfulLandingMetadata, 'title' | 'buttonStartNow' | 'whyThisToolTitle' | 'howWeHelpTitle' | 'didYouKnowTitle' | 'kitchenIntro' | 'articleTitle'>
      & { richDescription?: Maybe<(
        { __typename?: 'LandingMetadataDescription' }
        & Pick<GraphQLContentfulLandingMetadataDescription, 'json'>
      )> }
    ) | (
      { __typename: 'OfferingExampleViolation' }
      & Pick<GraphQLContentfulOfferingExampleViolation, 'title' | 'description' | 'violationReason' | 'order' | 'markerLeftPosition' | 'markerTopPosition'>
    ) | (
      { __typename: 'RelevantArticle' }
      & Pick<GraphQLContentfulRelevantArticle, 'title' | 'sourceUrl' | 'sourceName' | 'order'>
    ) | { __typename: 'ResourcesAndContacts' } | { __typename: 'RichTextOnly' }>> }
  )> }
);

export type GraphQLContentfulResourcesPageContentQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GraphQLContentfulResourcesPageContentQuery = (
  ...
  & { resourcesAndContactsCollection?: Maybe<(
    ...
    & { items: Array<Maybe<(
      { __typename: 'ResourcesAndContacts' }
      & Pick<GraphQLContentfulResourcesAndContacts, 'name' | 'nameUrl' | 'email' | 'phoneNumber' | 'phoneNumberExtension' | 'facebookName' | 'facebookUrl' | 'order'>
      & { richDescription?: Maybe<(
        { __typename?: 'ResourcesAndContactsDescription' }
        & Pick<GraphQLContentfulResourcesAndContactsDescription, 'json'>
      )> }
    )>> }
  )> }
);

export type GraphQLContentfulAllRichTextPagesQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GraphQLContentfulAllRichTextPagesQuery = (
  ...
  & { richTextOnlyCollection?: Maybe<(
    ...
    & { items: Array<Maybe<(
      { __typename: 'RichTextOnly' }
      & Pick<GraphQLContentfulRichTextOnly, 'path'>
    )>> }
  )> }
);
...
export type GraphQLContentfulRichTextPageQuery = (
  ...
  & { richTextOnlyCollection?: Maybe<(
    ...
    & { items: Array<Maybe<(
      { __typename: 'RichTextOnly' }
      & Pick<GraphQLContentfulRichTextOnly, 'title' | 'seoDescription' | 'showStartButton'>
      & { richDescription?: Maybe<(
        { __typename?: 'RichTextOnlyDescription' }
        & Pick<GraphQLContentfulRichTextOnlyDescription, 'json'>
      )> }
    )>> }
  )> }
);
