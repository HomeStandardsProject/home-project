...
export const HomeAssessmentDetails: React.FC<Props> = ({
  ...
  const [showInvalidMarkerIfNeeded, setShowInvalidMarkerIfNeeded] = React.useState(
    false
  );
  ...
  const handleWaterChange = React.useCallback((newValue: string) => {
    setDetails((details) => ({
      ...details,
  ...
  const handleHydroChange = React.useCallback((newValue: string) => {
    setDetails((details) => ({
      ...details,
  ...
  const handleGasChange = React.useCallback((newValue: string) => {
    setDetails((details) => ({
      ...details,
  ...
  const handleInternetChange = React.useCallback((newValue: string) => {
    setDetails((details) => ({
      ...details,
  ...
  const handleParkingChange = React.useCallback((newValue: string) => {
    setDetails((details) => ({
      ...details,
  ...
  const handleOtherChange = React.useCallback((newValue: string) => {
    setDetails((details) => ({
      ...details,
        ...
        <Stack>
          ...
          <FormControl
            ...
            isInvalid={
              ...
              !details.hydroInRent &&
              !details.gasInRent &&
              !details.internetInRent &&
              !details.parkingInRent &&
              !details.otherInRent &&
              showValidationErrors
            }
          >
